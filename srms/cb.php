    ...
    <div class="container">
      <div class="row content">
        ...
        <div class="col-sm-3">
          ...
          <form id="sh"  action="html.php" method="POST" enctype="multipart/form-data">
             <h3>Enter Semester</h3><br>
             <div class="input-group">
               <input type="text" class="form-control" placeholder="Enter Semester" name="AR"><button class="btn btn-default" type="submit">
                 search
               </button>
