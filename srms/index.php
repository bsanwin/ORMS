...
<br/>
  ...
  <table class="table">
    ...
    <tbody>
      <?php
          $table  = mysqli_query($conn ,'SELECT stu_id,sub_id,repeating,grade FROM student_sub');
          while($row  = mysqli_fetch_array($table)){ ?>
              <tr id="<?php echo $row['stu_id']; ?>">
                <td data-target="firstName"><?php echo $row['sub_id']; ?></td>
                <td data-target="lastName"><?php echo $row['repeating']; ?></td>
                <td data-target="email"><?php echo $row['grade']; ?></td>
